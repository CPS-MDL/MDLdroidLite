...
class MobileNetV2(nn.Module):
    def __init__(self, n_class=1000, input_size=20, width_mult=1., channel=3):
        ...
        self.features = [conv_bn(channel, input_channel, 2)]
...
if __name__ == '__main__':
    ...
    net = NetS(**kwargs)
    summary(net, (9, 1, 128))
    # macs, params = get_model_complexity_info(net, (9, 1, 128), as_strings=True,
