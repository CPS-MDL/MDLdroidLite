...
def main():
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        cor_list, pred_list = test(args, model, device, test_loader)
    ...
    if args.save_model:
        torch.save(model.state_dict(), "/Users/zber/ProgramDev/exp_pyTorch/results/model/mnist_cnn.pt")
